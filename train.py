...
def train_network(net,
    ...
    train_dataset = BaseData(dir_images_CT, dir_images_MV, dir_masks_CT, dir_masks_MV)
    validation_dataset = BaseData(dir_images_CT, dir_images_MV, dir_masks_CT, dir_masks_MV, train=False)
    ...
    val_loader = DataLoader(validation_dataset, batch_size=batch_size, shuffle=False, num_workers=8, pin_memory=True, drop_last=True)
