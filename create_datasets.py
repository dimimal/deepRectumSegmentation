...
def main():
    ...
    mvct_convhull_paths = sorted(glob.glob(MVCT_PATH + '/**/rectumT_man_seg_slice_convhull*'))
    ...
    mvct_images_paths, mvct_convhull_paths = clean_annotations(mvct_images_paths, mvct_convhull_paths, trim=False)
    ...
    # print(ct_mask_paths)
    export_images(ct_image_paths, ct_mask_paths, OUT_CT_PATH, resize=True, sampling_size=(512, 512),
            keys={'image': 'imageP', 'mask':'rectumP_seg_man'}, extract='ct')
